...
` $_SESSION['formKey'] ` is set to a value generated by ` mt_rand() `. Validation will compare this value to ` $_POST['formKey'] ` on every POST request then iterate the value.
